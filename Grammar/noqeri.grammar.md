...
The lexer also reserves `import`, `record` and `class`; they are intentionally not stable grammar until parser/type/runtime support is implemented and tested.
