...
int runProductionDoctor(const std::filesystem::path&root){
    ...
    const std::vector<Check>required={
        ...
        {"Doc/ABI.md","ABI contract documentation"},{"Doc/FREESTANDING.md","freestanding target documentation"},{"Doc/LANGUAGE_REFERENCE.md","language reference"},{"Grammar/noqeri.grammar.md","grammar contract"},{"InternalDocs/ARCHITECTURE.md","repository architecture study"},
