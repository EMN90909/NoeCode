...
int runProductionDoctor(const std::filesystem::path&root){
    ...
    const std::vector<Check>required={
        ...
        {"Compiler/core.cpp","compiler core"},{"Compiler/modules.cpp","module graph"},{"Compiler/type_checker.cpp","type checker"},{"Compiler/nir.cpp","NIR implementation"},{"Compiler/optimizer.cpp","optimizer"},{"Compiler/native_backend.cpp","native backend"},{"Compiler/linker.cpp","tool process/target adapter"},{"Compiler/bootstrap/noqeridb_host.cpp","NoqeriDB bootstrap host adapter"},{"Compiler/bootstrap/security_audit_host.cpp","security-audit bootstrap host adapter"},
        ...
        {"Modules/builtin.nqr","Noqeri built-in module helpers"},{"Modules/native.nqr","Noqeri native-module contract"},{"Objects/value.nqr","Noqeri value model"},{"Objects/text.nqr","Noqeri text/byte model"},{"Database/noqeridb.nqr","Noqeri database core"},{"Tools/security/policy.nqr","Noqeri security policy helpers"},{"Lib/test/assert.nqr","Noqeri test assertions"},
