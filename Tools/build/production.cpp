...
int runProductionDoctor(const std::filesystem::path& root) {
    ...
    const std::vector<Check> required = {
        ...
        {"tests/abi_services.nqr","ABI service test"},{"tests/systems_types.nqr","systems types test"}
    };
    int failures=0;
    ...
    if(failures==0){std::cout<<"noqeri production-track repository checks passed for language 1.3 and ABI v2.\n";return 0;}
