...
int runProductionDoctor(const std::filesystem::path& root) {
    ...
    const std::vector<Check> required = {
        ...
        {"Include/noqeri/abi.h","public ABI v2 header"},{"Doc/ABI.md","ABI contract documentation"},
        {"Doc/FREESTANDING.md","freestanding target documentation"},{"Doc/LANGUAGE_REFERENCE.md","language reference"},
        ...
        {"Compiler/optimizer.cpp","optimizer"},{"Compiler/native_backend.cpp","native backend"},{"Compiler/linker.cpp","platform adapter driver"},
        ...
        {"scripts/verify_repository.sh","repository verifier"},{"examples/hello.nqr","smoke example"},{"examples/general_systems.nqr","general systems example"},
        {"tests/arithmetic.nqr","test program"},{"tests/abi_services.nqr","ABI service test"},{"tests/systems_types.nqr","systems types test"},
        {"tests/general_capabilities.nqr","general capabilities test"},{"tests/module_math.nqr","module fixture"},{"tests/modules_imports.nqr","import graph test"}
    };
    int failures=0;
    ...
    if(failures==0){std::cout<<"noqeri production-track repository checks passed for language 1.4 and ABI v2.\n";return 0;}
