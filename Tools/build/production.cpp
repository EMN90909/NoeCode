...
int runProductionDoctor(const std::filesystem::path&root){
    ...
    const std::vector<Check>required={
        {"README.md","public README"},{"LICENSE","MIT license"},{"LEGAL.md","legal notice"},{"SECURITY.md","security policy"},{"CONTRIBUTING.md","contribution guide"},{"CHANGELOG.md","change log"},
        ...
        {"Doc/ABI.md","ABI contract documentation"},{"Doc/FREESTANDING.md","freestanding target documentation"},{"Doc/LANGUAGE_REFERENCE.md","language reference"},{"Grammar/noqeri.grammar.md","grammar contract"},{"InternalDocs/CPYTHON_STRUCTURE.md","repository architecture study"},
        ...
        {"Modules/README.md","module boundary"},{"Platforms/README.md","target matrix"},{"Benchmarks/README.md","benchmark policy"},{"Tools/fuzz/README.md","fuzzing policy"},{"editors/vscode/package.json","VS Code language package"},
        ...
        {"tests/arithmetic.nqr","test program"},{"tests/abi_services.nqr","ABI service test"},{"tests/systems_types.nqr","systems types test"},{"tests/general_capabilities.nqr","general capabilities test"},{"tests/module_math.nqr","module fixture"},{"tests/modules_imports.nqr","import graph test"}
    };
    int failures=0;
    std::cout<<"noqeri production-track doctor\ncompiler="<<NOQERI_COMPILER_VERSION<<"\nlanguage="<<NOQERI_LANGUAGE_VERSION<<"\nedition="<<NOQERI_EDITION<<"\nabi="<<NOQERI_ABI_VERSION<<"\ndefault-target="<<NOQERI_DEFAULT_TARGET<<"\ntargets="<<NOQERI_SUPPORTED_TARGET<<"\n";
